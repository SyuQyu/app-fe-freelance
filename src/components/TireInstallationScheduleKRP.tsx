...
const initialSchedules: InstallationSchedule[] = [
  {
    id: '1',
    scheduleNumber: 'KRP-2024-001',
    date: '2024-10-15',
    vehicleNumber: 'B 1111 KRP',
    vehicleType: 'Truck KRP',
    tireSize: '11R22.5',
    quantity: 2,
  ...
  {
    id: '2',
    scheduleNumber: 'KRP-2024-002',
    date: '2024-10-14',
    vehicleNumber: 'B 2222 KRP',
    vehicleType: 'Truck KRP',
  ...
  {
    id: '3',
    scheduleNumber: 'KRP-2024-003',
    date: '2024-10-14',
    vehicleNumber: 'B 3333 KRP',
    vehicleType: 'Truck KRP',
  ...
  {
    id: '4',
    scheduleNumber: 'KRP-2024-004',
    date: '2024-10-13',
    vehicleNumber: 'B 4444 KRP',
    vehicleType: 'Truck KRP',
    tireSize: '11R22.5',
    quantity: 2,
...
export function TireInstallationScheduleKRP() {
  ...
  const handleCreateSubmission = () => {
    const newSchedule: InstallationSchedule = {
      ...
      scheduleNumber: `KRP-2024-${String(schedules.length + 1).padStart(3, '0')}`,
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Jadwal Pemasangan Ban - KRP</h1>
          <p className="text-gray-600 mt-1">Kelola jadwal pemasangan dan penggantian ban kendaraan KRP</p>
        </div>
      ...
      <Dialog open={isCreatingSubmission} onOpenChange={setIsCreatingSubmission}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Buat Pengajuan Pemasangan Ban - KRP</DialogTitle>
          </DialogHeader>
